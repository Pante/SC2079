 ...
 * @version 1.0.0
 */
var ImagePredictionResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ImagePredictionResponse(imageId, obstacleId) {
    _classCallCheck(this, ImagePredictionResponse);
   ...
   */
  _createClass(ImagePredictionResponse, null, [{
    key: "initialize",
    value: function initialize(obj, imageId, obstacleId) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('obstacle_id')) {
          obj['obstacle_id'] = _ApiClient["default"].convertToType(data['obstacle_id'], 'Number');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ImagePredictionResponse.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ImagePredictionResponse;