...
var _PathfindingResponseSegmentInstructionsInner = _interopRequireDefault(require("./PathfindingResponseSegmentInstructionsInner"));
 ...
 * @version 1.0.0
 */
var PathfindingResponseSegment = /*#__PURE__*/function () {
  /**
   ...
   */
  function PathfindingResponseSegment(cost, imageId, instructions, path) {
    _classCallCheck(this, PathfindingResponseSegment);
   ...
   */
  _createClass(PathfindingResponseSegment, null, [{
    key: "initialize",
    value: function initialize(obj, cost, imageId, instructions, path) {
      obj['cost'] = cost;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cost')) {
          obj['cost'] = _Cost["default"].constructFromObject(data['cost']);
        }
        if (data.hasOwnProperty('image_id')) {
          obj['image_id'] = _ApiClient["default"].convertToType(data['image_id'], 'Number');
        }
        if (data.hasOwnProperty('instructions')) {
          obj['instructions'] = _ApiClient["default"].convertToType(data['instructions'], [_PathfindingResponseSegmentInstructionsInner["default"]]);
        }
        if (data.hasOwnProperty('path')) {
          obj['path'] = _Path["default"].constructFromObject(data['path']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PathfindingResponseSegment.RequiredProperties),
        _step;
      try {
      ...
      if (data['cost']) {
        // data not null
        _Cost["default"].validateJSON(data['cost']);
      }
      if (data['instructions']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _PathfindingResponseSegmentInstructionsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['path']) {
        // data not null
        _Path["default"].validateJSON(data['path']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = PathfindingResponseSegment;