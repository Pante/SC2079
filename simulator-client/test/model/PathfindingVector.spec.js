...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdpApi.PathfindingVector();
  });
  ...
  describe('PathfindingVector', function() {
    it('should create an instance of PathfindingVector', function() {
      // uncomment below and update the code to test PathfindingVector
      //var instance = new MdpApi.PathfindingVector();
      //expect(instance).to.be.a(MdpApi.PathfindingVector);
    });
