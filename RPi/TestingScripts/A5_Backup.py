...
class TaskA5:
	...
	def get_last_image(self) -> str:
		last = self.last_image
		if last is None:
			last = "NONE"
		print(f"Returning last_image as {last}")
		return last
	...
	def stream_start(self):
		...
		server = StreamServer()
		print("Initialised stream server.")
		server.start()
	...
	def stm_receive(self) -> None:
		...
		while True:
			...
			try:
				...
				print("Message received from STM:", message_rcv.rstrip())
