...
class Obstacle(BaseModel):
    ...
    """ # noqa: E501
    direction: StrictStr
    north_east: List[StrictInt]
    south_west: List[StrictInt]
    ...
    def direction_validate_enum(cls, value):
        ...
        if value not in ('NORTH', 'EAST', 'SOUTH', 'WEST'):
            raise ValueError("must be one of enum values ('NORTH', 'EAST', 'SOUTH', 'WEST')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "north_east": obj.get("north_east"),
            "south_west": obj.get("south_west")
        })
        return _obj
