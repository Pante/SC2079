...
var _PathfindingResponseSegment = _interopRequireDefault(require("./PathfindingResponseSegment"));
 ...
 * @version 1.0.0
 */
var PathfindingResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function PathfindingResponse(segments) {
    _classCallCheck(this, PathfindingResponse);
   ...
   */
  _createClass(PathfindingResponse, null, [{
    key: "initialize",
    value: function initialize(obj, segments) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('segments')) {
          obj['segments'] = _ApiClient["default"].convertToType(data['segments'], [_PathfindingResponseSegment["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PathfindingResponse.RequiredProperties),
        _step;
      try {
      ...
      if (data['segments']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['segments']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _PathfindingResponseSegment["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = PathfindingResponse;