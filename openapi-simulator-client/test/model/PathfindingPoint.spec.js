...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdpApi.PathfindingPoint();
  });
  ...
  describe('PathfindingPoint', function() {
    it('should create an instance of PathfindingPoint', function() {
      // uncomment below and update the code to test PathfindingPoint
      //var instance = new MdpApi.PathfindingPoint();
      //expect(instance).to.be.a(MdpApi.PathfindingPoint);
    });
